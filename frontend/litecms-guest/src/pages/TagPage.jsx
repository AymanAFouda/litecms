...
const contents = [
  ...
  },
  {
    ...
    description: "A visual journey through some of the most beautiful and lesser-known beaches.",
  ...
  },
  {
    ...
    description: "Learn the fundamentals of building REST APIs using Spring Boot.",
    contentType: "Video",
  ...
  },
  {
    ...
    description: "Comparing the most popular frontend frameworks developers are using this year.",
    contentType: "Article",
    category: "Programming",
    viewCount: 32145
  },
  {
    ...
    description: "A visual exploration of unique dishes and food cultures.",
    contentType: "Photo Gallery",
  ...
  },
  {
    ...
    featuredImage: "/images/post-3.png",
    description: "Key announcements and breakthrough innovations revealed this year.",
    contentType: "Video",
