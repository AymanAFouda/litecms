    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const basePayload = {
                ...
                tags: formData.tags.map(tag => tag.value).join(","),
            ...
            if(id) {
                const updatePayload = {
                    ...basePayload,
                    viewCount: editingArticle?.viewCount,
                    likeCount: editingArticle?.likeCount,
                }
                ...
                <div className="col-md-12 col-sm-12">
                    <div className="x_panel">
                        ...
                        <div className="x_content">
                            <br />
                            if(id && loadArticleFailed) {
                                (id && loadArticleFailed)
                            } else {(
